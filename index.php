...
<body>
        ...
        <div class="contenedor-registro">
          ...
          <form
            ...
            <div class="grupo-formulario grupo-checkbox">
              ...
              <label for="terminos">Acepto los <a href="#" id="ver-terminos" class="enlace-terminos">términos y condiciones</a></label>
            </div>
            <input
              type="submit"
              value="Registrarse"
  ...
  <!-- Modal: Términos y Condiciones -->
  <div id="modal-terminos" class="modal-overlay" aria-hidden="true" role="dialog" aria-modal="true" aria-labelledby="titulo-terminos">
    <div class="modal-contenido">
      <button class="modal-cerrar" aria-label="Cerrar modal">&times;</button>
      <h3 id="titulo-terminos">Términos y Condiciones</h3>
      <p>Al usar esta plataforma de cuidado de mascotas, aceptas los siguientes términos. Te recomendamos leerlos con atención.</p>
      <ul>
        <li>Brindaremos el servicio "tal cual"; no garantizamos disponibilidad ininterrumpida.</li>
        <li>Eres responsable de la veracidad de los datos que registras.</li>
        <li>Tu información se procesa conforme a nuestras prácticas de privacidad con fines operativos de la app.</li>
        <li>Está prohibido el uso fraudulento, abusivo o para fines distintos a los previstos.</li>
        <li>Podemos actualizar estos términos; los cambios se publicarán en esta plataforma.</li>
      </ul>
      <p>Si no estás de acuerdo, por favor no continúes con el registro.</p>
    </div>
  </div>
  ...
  <script>
    ...
    document.addEventListener("DOMContentLoaded", () => {
      ...
      enlaceTerminos && enlaceTerminos.addEventListener("click", abrir);
      btnCerrar && btnCerrar.addEventListener("click", cerrar);
