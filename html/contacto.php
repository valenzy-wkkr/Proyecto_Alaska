...
<body>
        ...
        <div class="contenedor-contacto">
          <div class="info-contacto-pagina">
            ...
            <div class="detalles-contacto">
              ...
              <div class="detalle">
                <div class="icono-contacto"><i class="fas fa-envelope"></i></div>
                <div class="texto-contacto">
                  <h3>Email</h3>
                  <p>info@alaska-mascotas.com</p>
                </div>
              </div>
              <div class="detalle">
          ...
          <div class="formulario-contacto">
            ...
            <form action="https://formsubmit.co/0d1802db591534bb6b7efe59c95df143" method="POST" id="formulario-contacto" enctype="multipart/form-data">
              ...
              <div class="grupo-formulario"><label for="nombre-contacto">Nombre Completo</label>
                <div class="entrada-con-icono"><i class="fas fa-user"></i><input type="text" id="nombre-contacto" name="name" placeholder="Tu nombre completo" required></div>
              </div>
              <div class="grupo-formulario"><label for="email-contacto">Correo Electrónico</label>
                <div class="entrada-con-icono"><i class="fas fa-envelope"></i><input type="email" id="email-contacto" name="email" placeholder="ejemplo@correo.com" required></div>
              </div>
              <div class="grupo-formulario"><label for="telefono-contacto">Teléfono</label>
                <div class="entrada-con-icono"><i class="fas fa-phone"></i><input type="tel" id="telefono-contacto" name="phone" placeholder="Tu número de teléfono"></div>
              </div>
              <div class="grupo-formulario"><label for="asunto-contacto">Asunto</label>
                <div class="entrada-con-icono"><i class="fas fa-tag"></i><input type="text" id="asunto-contacto" name="subject" placeholder="Asunto de tu mensaje" required></div>
              </div>
        ...
        <div class="contenedor-faq">
          <div class="item-faq">
            <div class="pregunta-faq">
              <h3>¿Cómo puedo registrarme en la aplicación?</h3><i class="fas fa-chevron-down"></i>
            </div>
            <div class="respuesta-faq">
              <p>Puedes registrarte fácilmente haciendo clic en el botón "Registrarse" en la parte superior de nuestra página. Completa el formulario con tus datos y ¡listo! Ya podrás acceder a todas nuestras funcionalidades.</p>
            </div>
          </div>
          <div class="item-faq">
            <div class="pregunta-faq">
              <h3>¿La aplicación es gratuita?</h3><i class="fas fa-chevron-down"></i>
            </div>
            <div class="respuesta-faq">
              <p>Ofrecemos una versión básica gratuita con funcionalidades limitadas. También contamos con planes premium que incluyen todas las características por una suscripción mensual o anual.</p>
            </div>
          </div>
          <div class="item-faq">
            <div class="pregunta-faq">
              <h3>¿Cómo funciona el sistema de recordatorios?</h3><i class="fas fa-chevron-down"></i>
            </div>
            <div class="respuesta-faq">
              <p>Nuestro sistema de recordatorios te permite configurar alertas para vacunas, medicamentos, citas veterinarias y paseos. Recibirás notificaciones en tu dispositivo en los horarios que hayas programado.</p>
            </div>
          </div>
          <div class="item-faq">
            <div class="pregunta-faq">
              <h3>¿Puedo registrar más de una mascota?</h3><i class="fas fa-chevron-down"></i>
            </div>
            <div class="respuesta-faq">
              <p>¡Por supuesto! Puedes registrar todas las mascotas que desees en tu cuenta y gestionar la información de cada una de manera independiente.</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <script>
    ...
    (function() {
      ...
      cont.textContent = ok ? '¡Tu mensaje fue enviado correctamente!' : 'Hubo un problema al enviar tu mensaje. Inténtalo de nuevo.';
      cont.classList.add(ok ? 'exito' : 'error');
    ...
    (function() {
      ...
      function msg(ok, t) {
        cont.textContent = t;
        cont.classList.remove('exito', 'error');
        cont.classList.add(ok ? 'exito' : 'error');
        cont.style.display = 'block';
        setTimeout(() => {
          cont.style.display = 'none';
      ...
      form.addEventListener('submit', async (e) => {
        try {
          ...
          if (resp.ok && ct.includes('application/json')) {
            ...
            ok = !!data.success;
            mensaje = data.message || (ok ? '¡Tu mensaje fue enviado correctamente!' : 'Hubo un problema al enviar tu mensaje. Inténtalo de nuevo.');
          } else {
            ok = resp.ok;
            mensaje = ok ? '¡Tu mensaje fue enviado correctamente!' : 'Hubo un problema al enviar tu mensaje. Inténtalo de nuevo.';
          }
          msg(ok, mensaje);
          if (ok) form.reset();
        } catch (_) {
          msg(false, 'No se pudo enviar el mensaje. Verifica tu conexión e inténtalo nuevamente.');
        } finally {
          const btn = form.querySelector('[type="submit"]');
          if (btn) {
            btn.disabled = false;
